...
\begin{table}[!ht]
\footnotesize
\caption{Tips for engaging at the \SPI{} after \textcite{OliverC2019}}\label{tab:litstrategies}
%\begin{tabular}{L{.22\linewidth}L{.56\linewidth}L{.22\linewidth}} 
\begin{tabular}{B{.66\linewidth}B{.34\linewidth}} 
\textbf{description} & \textbf{empirical examples} \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Do high quality research}} \\[2mm]
Research should be relevant to policy and rigorously performed, determining uncertainties, strengths and weaknesses 	 & 	\textcite{RoseBOP2018,OjanenBKP2021}  \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Effectively communicate research}} \\[2mm]
Communicate research findings in ways that are credible, accessible and meaningful to policymakers	 & 	\textcite{RoseBOP2018,Obermeister2022}  \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Understand policy processes}} \\[2mm]
Policymaking is non-linear and dynamic, evidence will need to be translated for specific purposes	 & 	\textcite{Obermeister2022}  \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Be accessible to policymakers}} \\[2mm]
Scientific advice is often required a specific times to address specific questions	 & 	\textcite{GogginEtAl2015}  \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Decide if you want to be an issue advocate or honest broker}} \\[2mm]
Many commentators find the two roles incompatible with each other and recommend being open about advocating for particular causes & \textcite{VerfuerthDCWP2023} \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Build relationships with policymakers}} \\[2mm]
Trust and shared language and understandings take time to develop but are essential under pressurised situations	 & 	\textcite{OjanenBKP2021}  \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Be `entrepreneurial' or find someone who is}} \\[2mm]
Engagements with policy require effort to build and maintain relationships and trust, this may be too much effort for an individual  scientist therefore collaboration with others is recommended	 & 	\textcite{RoseBOP2018}  \\[2mm] \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{\small Reflect continuously}} \\[2mm]
The science-policy and personal contexts require different approaches and decisions on whether to engage & 	\textcite{OjanenBKP2021,Obermeister2022} \\[2mm]
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{B{.48\linewidth}B{.305\linewidth}B{.215\linewidth}} 
\textbf{description} & \textbf{similar roles} & \textbf{empirical examples} \\ \hline
\multicolumn{3}{c}{\textbf{Pure Scientist}} \\ 
...
\multicolumn{3}{c}{\textbf{Science Communicator}} \\ 
...
\multicolumn{3}{c}{\textbf{Science Arbiter}} \\ 
...
\multicolumn{3}{c}{\textbf{Science Adviser}} \\ 
...
\multicolumn{3}{c}{\textbf{Knowledge Broker}} \\ 
...
\cite{JagannathanEtAl2023} - boundary spanning ``roles and their associated practices, expectations, institutional supports, and capacities vary greatly ... empirical analyses of such boundary functions are far and few ... also limited examination of the risks they may face while engaging in such a crucial role''\improvement{use practices instead of strategies?}
