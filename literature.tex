...
\begin{table}[!ht]
\footnotesize
\caption{Tips for engaging at the \SPI{} from \textcite{OliverC2019}}\label{tab:litstrategies}
%\begin{tabular}{L{.22\linewidth}L{.56\linewidth}L{.22\linewidth}} 
\begin{tabular}{L{.66\linewidth}L{.34\linewidth}} 
\textbf{description} & \textbf{empirical examples} \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{do high quality research}} \\[2mm]
Research should be relevant to policy and rigorously performed, determining uncertainties, strengths and weaknesses 	 & 	\textcite{RoseBOP2018,OjanenBKP2021}  \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{effectively communicate research}} \\[2mm]
Communicate research findings in ways that are credible, accessible and meaningful to policymakers	 & 	\textcite{RoseBOP2018,Obermeister2022}  \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{understand policy processes}} \\[2mm]
Policymaking is non-linear and dynamic, evidence will need to be translated for specific purposes	 & 	\textcite{Obermeister2022}  \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{be accessible to policymakers}} \\[2mm]
Scientific advice is often required a specific times to address specific questions	 & 	\textcite{GogginEtAl2015}  \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{decide if you want to be an issue advocate or honest broker}} \\[2mm]
Many commentators find the two roles incompatible with each other and recommend being open about advocating for particular causes & \textcite{VerfuerthDCWP2023} \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{build relationships with policymakers}} \\[2mm]
Trust and shared language and understandings take time to develop but are essential under pressurised situations	 & 	\textcite{OjanenBKP2021}  \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{be `entrepreneurial' or find someone who is}} \\[2mm]
Engagements with policy require effort to build and maintain relationships and trust, this may be too much effort for an individual  scientist therefore collaboration with others is recommended	 & 	\textcite{RoseBOP2018}  \\ \hline \\[-8mm] & \\
\multicolumn{2}{c}{\textbf{reflect continuously}} \\[2mm]
...
\begin{tabular}{L{.48\linewidth}L{.3\linewidth}L{.22\linewidth}} 
...
Interprets the science and draws attention to the implications (\cite{RapleyD2014}) & Interpreting (\cite{SteelLLS2004}) & \textcite{SteelLLS2004,SinghTKMMC2014} \\ \hline
...
\multicolumn{3}{c}{\textbf{Issue Advocate}} \\ 
