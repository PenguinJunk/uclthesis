...
\begin{tabular}{L{.07\linewidth}L{.3\linewidth}L{.11\linewidth}L{.52\linewidth}} \hline
\textbf{id} & \textbf{indicator label} & \textbf{influence} & \textbf{example quotes} \\ \hline \hline 
Ip01 & knowing there are influences other than science & neutral & \tquote{scientists themselves do not take into account that policymakers have millions of different sources for information for their decision making}{p11}{81} \\
