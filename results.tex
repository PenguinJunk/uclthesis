...
\begin{tabular}{B{.25\linewidth}L{.2\linewidth}L{.15\linewidth}L{.15\linewidth}}
\textbf{background} & \textbf{current focus} & \textbf{female} & \textbf{male} \\ \hline
...
iv02 & moral imperative & enabling & \tquote{it would be morally not possible to not want to do the engagement if you knew the things I found out}{p08}{131} \\[5mm]
iv03 & social justice & enabling & \tquote{... economic theories that might theoretically be the most efficient ones but are also extremely regressive and would be extremely harmful to poor and vulnerable populations}{p09}{77} \\[5mm]
