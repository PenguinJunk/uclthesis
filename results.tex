...
\begin{tabular}{L{.07\linewidth}L{.3\linewidth}L{.11\linewidth}L{.52\linewidth}} \hline
\textbf{id} & \textbf{indicator label} & \textbf{influence} & \textbf{example quotes} \\ \hline \hline 
Gp01 & \vfill\multirow{2}{*}{\parbox{.5\linewidth}{\raggedright laws; policies; governance rules; international conventions}} & neutral & \tquote{we've done a lot of work on comparing ... emissions with the greenhouse gas inventory that each country reports to the United Nations Framework Convention on Climate Change}{p02}{11} \\
...
sG02 & researching impacts of anticipated policy & \tquote{we wanted it to reflect kinds of things that ... government were thinking of doing}{p03}{27} \\ 
