...
%\begin{figure}[!ht]
%    \centering
%    \includegraphics[width=1\linewidth]{figures/phi_coefficient_with_strategy.png}
%    \caption{Phi coefficient for each ISM factor against strategy}
%    \label{fig:ismphistrategy}
%\end{figure}
