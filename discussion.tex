...
\tquote{I think [I] probably feel more [disappointed by the UK policy system] as a citizen or a taxpayer ... than as a researcher}{p08}{32} \vfill \tquote{Whereas of course, as a scientist you can again nicely study why that is the case and therefore the scientific frustration is low but the societal frustration high}{p09}{59}
...
A great many of the [strategies] identified by participants fit into the tips described in \textcite{OliverC2019}. However, a few stand out:

diverse engagements - seeking dialogue and collaboration beyond policy to industry and citizens (as02,ps04,ps05)
challenging policymaking perspectives - (ps03) using science thinking (fs04)
demand recognition (is05)

others go further:
diverse strategies - trying many different approaches at the same time
establish joint resources (ifs01)
working together with policymakers on a topic or in a particular venue (ns02, ns03, ks01,) - speaks to a more [equal] relationship than much if the normative advice indicates
working together with other stakeholders (ts05, ts06)
...
reflect existing policy in scientific analysis and anticipating changes in policy landscape (ps01,ps02,ps03) 
engage more locally (venue shopping)

some of these are akin to [strategies] of the \PE! 
...
\paragraph{The security framing}
...
\paragraph{speak when you're spoken to}
...
\paragraph{how to engage when my science is not a chosen topic?}


\subsection{Summary}
Experienced participants had diverse strategies
Using challenge, not just aligning

\section{Scientists' experiences at the CAN science-policy interface}\label{sec:disexperience}

\subsection{levels of policy}
...
\paragraph{hooked on engagement}
