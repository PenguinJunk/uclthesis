...
\include{preamble}\glsresetall
\include{introduction}\glsresetall
\include{literature}\glsresetall
\include{methods}\glsresetall
\include{results}\glsresetall
\include{discussion}\glsresetall
\include{conclusions}\glsresetall
